...
<p>&nbsp;而后续开发工作主要是基于0.0.4+，由于虽然0.0.3.x系列依赖的SpringBoot2.3.12仍是SpringCloud目前生态最完整的版本，但官方已经于今年停止了该版本的维护，后续必然会基于新的SpringBoot版本进行相关生态的发布，所以后续0.0.4.x也会以此为准进行迭代升级，紧跟SpringCloud的生态升级</p>
