 ...
 *
 */
public class AradinRedisCacheWriterOld implements RedisCacheWriter {
	 ...
	 */
	public AradinRedisCacheWriterOld(RedisConnectionFactory connectionFactory, BatchStrategy batchStrategy, RedisCacheManagerProperties redisCacheManagerProperties) {
	 ...
	 * @param redisCacheManagerProperties must not be {@literal null}.
	 */
	AradinRedisCacheWriterOld(RedisConnectionFactory connectionFactory, Duration sleepTime, BatchStrategy batchStrategy, RedisCacheManagerProperties redisCacheManagerProperties) {
	 ...
	 * @param batchStrategy must not be {@literal null}.
	 */
	AradinRedisCacheWriterOld(RedisConnectionFactory connectionFactory, Duration sleepTime,
	...
	public RedisCacheWriter withStatisticsCollector(CacheStatisticsCollector cacheStatisticsCollector) {
		return new AradinRedisCacheWriterOld(connectionFactory, sleepTime, cacheStatisticsCollector, this.batchStrategy, redisCacheManagerProperties);
	}
